...
// Add the click event to the info icon
newCard.innerHTML = `
  <div class="card-header" style="display: flex; justify-content: space-between; align-items: center;">
    ...
    <div class="icon-group" style="display: flex; gap: 0x;">
        ...
        <!-- Trash Icon -->
        <a class="bx bx-trash icon" title="Move to Trash" onclick="openTrashModal('${fileName}', this)"></a>
        <!-- Info Icon -->
        <a class="bx bx-info-circle icon" title="File Information" onclick="openFileInfoModal('${fileName}', '250', '2024-11-30')"></a> <!-- Example values for size and date -->
    </div>
  </div>
