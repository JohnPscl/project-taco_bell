...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="dashboard/personal-info.css" />
        ...
        <ul class="menu_items">
          ...
          <li class="item">
            ...
            <ul class="menu_items submenu">
              <li><a href="" class="nav_link sublink">Personal Info</a></li>
              <li><a href="account-settings.php" class="nav_link sublink">Account Settings</a></li>
            </ul>
          </li>
...
<div class="content">
  <h1 class="page-heading">Personal Info</h1>
  <hr class="divider">
  ...
  <!-- Rectangle -->
  <div class="big-rectangle rectangle-info1">
    <div class="info-user">
      <img class="info-img" src="dashboard/Icons/user.png">
    </div>
  
  </div>
   <!-- Rectangle -->
   <div class="big-rectangle rectangle-info2">
