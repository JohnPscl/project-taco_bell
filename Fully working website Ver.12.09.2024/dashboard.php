...
function uploadProfilePicture() {
    ...
    const firstName = "John";  // Replace with dynamic data if necessary
    const lastName = "Doe";    // Replace with dynamic data if necessary
    const department = "CS";   // Replace with dynamic data if necessary
    ...
    .then(data => {
        if (data.success) {
            // If the upload is successful, update the image preview
            const imagePreview = document.getElementById("profileImagePreview");
            imagePreview.src = 'uploads/profile_pics/' + data.profilePicture;
        } else {
