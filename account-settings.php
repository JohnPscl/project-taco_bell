...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar" style="display: none;">
      ...
      <div class="navbar_content" style="display: none;">
        ...
        <ul class="menu_items">
          ...
          <li class="item">
            ...
            <ul class="menu_items submenu">
              <li><a href="personal-info.php" class="nav_link sublink">Personal Info</a></li>
              <li><a href="#" class="nav_link sublink">Account Settings</a></li>
            </ul>
          </li>

        </ul>

        <!-- Sidebar Bottom Content and Drop-up Menu -->
...
<div class="content">
    ...
    <div class="big-rectangle">
        ...
        <div class="account-description">Keep your access to your account seamless by regularly updating this information.</div>

        <!-- Buttons -->
        <!-- Account Buttons -->
        <div class="account-buttons">

          <button class="account-button" id="emailButton">
          <span class="account-label">Email</span>
          <span class="user-email">user@gmail.com</span>
          <i class="bx bx-chevron-right arrow-left-2"></i>
          </button>

          <button class="account-button" id="passwordButton">
          <span class="account-label">Password</span>
          <span class="user-password">****************</span>
          <i class="bx bx-chevron-right arrow-left-2"></i>
          </button>

          <button class="account-button" id="facultyIdButton">
          <span class="account-label">Faculty ID</span>
          <span class="user-id">123456</span>
          <i class="bx bx-chevron-right arrow-left-2"></i>
          </button>
...
<!-- Password Modal -->
<div id="modalPassword" class="modal-password" style="display: none;">
  <div class="modal-password-content">
    <span class="close-btn-password">&times;</span>
